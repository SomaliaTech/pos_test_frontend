...
const MessageContect = () => {
  const user = useUserStore((state) => state.user);
  const [formData, setFormData] = useState({
    name: user?.name ? user.name : "",
    email: user?.phone || user?.email ? user.phone : "",
    message: "",
  });
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="md:flex">
            ...
            <div className="hidden md:block md:w-2/5 bg-gradient-to-br from-blue-600 to-indigo-700 text-white p-8">
              <h2 className="text-2xl font-bold mb-6">Get in Touch</h2>

              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center flex-shrink-0 mr-4">
                    <svg
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100">support@foodscan.com</p>
                  </div>
                </div>
              </div>
